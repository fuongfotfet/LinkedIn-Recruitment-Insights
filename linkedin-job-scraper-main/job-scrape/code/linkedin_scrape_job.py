...
# Ensure the downloaded ChromeDriver has execution permissions
...
urls = [
    'https://www.linkedin.com/jobs/search?keywords=Techcombank&location=Vietnam',
]
...
if __name__ == '__main__':
    ...
    if len(df) == 0:
        ...
        df.to_csv('VCB-job-Vietnam.csv', mode='w', index=False)